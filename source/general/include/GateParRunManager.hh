...
// ********************************************************************
//
/// \file general/include/GateParRunManager.hh
...
#ifndef GateParRunManager_h
#define GateParRunManager_h 1
...
class GateParRunManager : public GateRunManager
{
  ...
  private:  // TOP-C callbacks
    ...
    static GateParRunManager* myRunManager;
  ...
  // Copies of local variables of GateRunManager::DoEventLoop()
    ...
    inline void ImportDoEventLoopLocals(
      ...
      {
        GateParRunManager::stateManager = stateManager;
        GateParRunManager::n_event = n_event;
        GateParRunManager::n_select = n_select;
        GateParRunManager::msg = msg;
        GateParRunManager::myRunManager = this;
      }
...
public: // with description
  ...
  public:
    ...
    { 
      ...
      { 
        ...
        G4cerr << " return value = " << sysret << Gateendl;
      }
    }
  ...
  public: // with description
    ...
    {
      G4cerr << "CutOffHasBeenModified becomes obsolete.\n";
      G4cerr << "It is safe to remove invoking this method.\n";
    }  
